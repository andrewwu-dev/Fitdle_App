const instructions = {
  ...
  'bicepCurl':
      'Hold a weighted barbell with your palms facing up, keep your elbows close to your body, curl the weight towards your shoulders, and then slowly lower it back down to your starting position.',
  'pushup':
